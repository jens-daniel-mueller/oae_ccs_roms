...
```{r sst_clim_baseline, message=FALSE, fig.dim=c(6,4)}
...
```{r sst_anomalies, message=FALSE, fig.dim=c(7,5)}
...
```{r sst_running_annual_mean, message=FALSE, warning=FALSE}
...
```{r metric_clim_baseline, message=FALSE, fig.dim = c(7, 6)}
...
```{r metric_anomalies, message=FALSE, fig.dim = c(7, 6)}
...
```{r metric_running_annual_mean, message=FALSE, warning=FALSE, fig.dim=c(7,8)}
...
```{r metrics_correlation_coeffs, message=FALSE, include=FALSE}
