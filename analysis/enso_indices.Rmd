...
```{r sst_clim_baseline, message=FALSE, fig.dim=c(5,3)}
...
```{r sst_anomalies, message=FALSE, fig.dim=c(6,3)}
...
```{r metric_running_annual_mean, message=FALSE, warning=FALSE, fig.dim=c(7,3)}
