...
surface_pert_dic <- 
  ...
  mutate(
    DIC_pert = carb(
      flag = 24,
      var1 = pco2_calc, # for consistency, use the calculate pCO2 here, otherwise you compute a DIC perturbation that is partly due to differences in the computational routines
